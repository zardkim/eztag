...
/* ── 푸터 ── */
.footer { text-align: center; font-size: 11px; color: var(--text3); padding-top: 16px; border-top: 1px solid var(--border); }
...
"""
    ...
    for t in tracks:
        ...
        td_parts += [
            ...
            f'<td><div class="title-cell">{_safe(t.get("title") or "")}{lyrics_dot}</div></td>',
    ...
    source_note = f'<br><span style="font-size:10px;color:var(--text3);">{_safe(folder_name)}</span>' if folder_name else ""
...
<div class="page">
  ...
  <div class="album-header">
    ...
    <div class="album-info">
      ...
      <div class="album-stats">{_safe(stats_html)}</div>
    </div>
  </div>
  <!-- 트랙 목록 -->
...
{desc_html}
  <!-- 푸터 -->
  <div class="footer">
    Generated by <a href="#">eztag</a> · {now_str}{source_note}
  </div>
