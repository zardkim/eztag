...
- **LRC 가사 가져오기** — 알송(AlSong) · Bugs · LRCLIB 소스에서 LRC 가사 파일 자동 저장
...
| LRC 검색 기본설정 | 기본 LRC 소스 선택 (알송 · Bugs · LRCLIB), 카드형 UI로 선택 |
...
| 버전 | 날짜 | 주요 변경사항 |
|------|------|--------------|
| **v0.8.17** | 2026-03-30 | 알송(AlSong) LRC 검색 추가, 앨범카드 소개 접기/펼치기, 설정 LRC 카드형 UI, YouTube MV 검색 정확도 강화, 미니플레이어 비트레이트 1줄 표시 |
...
| v0.8.12 | 2026-03-28 | Bugs Music 403 우회(HTML 파싱), LRC 검색 안정화 |
