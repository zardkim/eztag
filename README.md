...
| 버전 | 날짜 | 주요 변경사항 |
|------|------|--------------|
| **v0.10.4** | 2026-09-07 | 하위 폴더 목록을 탐색기형으로 변경 + 정렬 추가, 모바일 폴더 시트 높이 확대, arm64 이미지 빌드 멈춤 수정 |
| v0.10.3 (결함) | 2026-09-07 | 하위 폴더 목록을 탐색기형으로 변경 + 정렬 추가, 모바일 폴더 시트 높이 확대, 좁은 화면 폴더명 잘림 수정 |
